...
Game.prototype.isWrongMove = function(move) {
  ...
  return isWrongMove(move,previousMove,15);
}

Game.prototype.hasWonGame = function() {
  return this.playedMoves[this.playedMoves.length-1] <= 15;
}
...
let changeLevel = function() {
  location.href = '../myMineCraft4/index.html';
}
...
let startingNumbers = [405,404,403,402,401,400,399,398,397,396,395,394,393,392,391]
let index = Math.floor(Math.random()*startingNumbers.length);
let path = giveGamePath(15,startingNumbers[index]);
game = new Game(path);
